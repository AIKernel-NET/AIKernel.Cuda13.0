...
This is part of the AIKernel 0.1.2 publication preparation line. The package
...
1. Publish AIKernel.NET and AIKernel.Core managed dependencies first.
   ...
   may be a cache-busting build such as `0.1.2-dev{build-number}`; for the
   public v0.1.2 CUDA release, it should point at the already-published
